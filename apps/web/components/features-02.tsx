      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Voice, automation, and handoffs in one place.</h2>
            <p className="text-lg text-slate-400">Every EarlyBird deployment combines natural conversation, real-time routing, and the guardrails your ops team requires&mdash;no duct tape or extra headcount.</p>
          </div>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                        <div className="mb-5">
                          <div>
                            <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">Launch-ready onboarding</h3>
                            <p className="text-slate-400">Import scripts, FAQs, calendars, and routing rules in minutes. Your receptionist mirrors brand tone while respecting consent prompts and compliance requirements.</p>
                          </div>
                        </div>
                        <div>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">Live transfer when it matters</h3>
                          <p className="text-slate-400">Route urgent calls to SMS, Slack, or a live teammate instantly. EarlyBird captures context before handoff so nothing is lost in translation.</p>
                        </div>
                      </div>
                      {/* Image */}
                ...
                <HighlighterItem>
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">Analytics & QA built in</h3>
                          <p className="text-slate-400">Review transcripts, call summaries, and booking outcomes from one dashboard. Spot opportunities and coach the AI like you would a teammate.</p>
                        </div>
                      </div>
                      {/* Image */}
                      <div className="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Call routing controls</h4>
              </div>
              <p className="text-sm text-slate-400">Direct after-hours, overflow, and VIP calls based on business rules—no IVR trees.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Calendar sync</h4>
              </div>
              <p className="text-sm text-slate-400">Two-way sync with Google and Microsoft calendars keeps availability accurate automatically.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">CRM logging</h4>
              </div>
              <p className="text-sm text-slate-400">Push transcripts, tags, and next steps into HubSpot, Salesforce, or Slack with one click.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Voice selection</h4>
              </div>
              <p className="text-sm text-slate-400">Choose from multiple voices and languages, all tuned to your brand tone.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Compliance guardrails</h4>
              </div>
              <p className="text-sm text-slate-400">SOC 2-ready logging, consent prompts, and PII handling give compliance teams confidence.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Automated follow-up</h4>
              </div>
              <p className="text-sm text-slate-400">Trigger SMS or email follow-ups so callers always get confirmation without staff time.</p>
            </div>
          </div>
