...
const KEY = "eb_forwarding_banner_dismissed_v1";
...
export default function PortingBanner() {
  ...
  return (
    <div className="mt-3 rounded-xl border border-white/10 bg-white/5 p-3 text-sm text-white/80 flex items-start justify-between gap-3">
      <div>
        Using an existing business number? Forward it to EarlyBird in minutes. <a href="/support/porting" className="underline">Set up forwarding</a>.
      </div>
      <button
