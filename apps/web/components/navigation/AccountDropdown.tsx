  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {open ? (
        <div
          role="menu"
          className="absolute right-0 top-full z-50 translate-y-2 md:translate-y-3 w-full min-w-[12rem] max-w-[calc(100vw-2.5rem)] overflow-visible rounded-3xl border border-white/12 bg-[#05050b]/97 py-3 text-sm shadow-[0_28px_70px_rgba(5,5,11,0.45)] backdrop-blur sm:min-w-[14.5rem] md:w-64 md:max-w-none before:absolute before:right-6 before:-top-2 before:h-3.5 before:w-3.5 before:rotate-45 before:rounded-sm before:border before:border-white/12 before:bg-[#05050b]/97 before:content-['']"
        >
