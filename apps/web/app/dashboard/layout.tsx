          ...
          <div className="sticky top-0 z-30 border-b border-white/10 bg-neutral-950/75 backdrop-blur supports-[backdrop-filter]:bg-neutral-950/55">
            <div className="flex items-center justify-between px-4 py-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <input type="search" placeholder="Search" className="ml-2 bg-white/5 border border-white/10 rounded-md px-3 py-1.5 text-sm placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-white/20" />
              </div>
            </div>
          </div>
