...
const CSP_DIRECTIVES = (
  ...
  "base-uri 'none'",
  "object-src 'none'",
  `script-src 'self' 'nonce-${nonce}' https://js.stripe.com https://unpkg.com https://www.googletagmanager.com`,
  "script-src-attr 'none'",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "img-src 'self' data: blob: https:",
  "font-src 'self' https://fonts.gstatic.com",
  "connect-src 'self' https://api.oneearlybird.ai https://www.google-analytics.com https://www.googletagmanager.com",
